  ...
  useEffect(() => {
    ...
    const map = new window.google.maps.Map(mapRef.current, {
      ...
      styles: [
        ...
        { featureType: 'road.highway', elementType: 'geometry.fill', stylers: [{ color: '#D4B896' }] },
        { featureType: 'road.highway', elementType: 'geometry.stroke', stylers: [{ color: '#B8965A' }, { weight: 1.5 }] },
        ...
        { featureType: 'park', elementType: 'geometry.fill', stylers: [{ color: '#d4e8c8' }] },
        ...
        { featureType: 'administrative', elementType: 'geometry.stroke', stylers: [{ color: '#c4b090' }] },
      ],
    });
